...
from museme.models import Song, Watchlater, History, Channel
...
def history(request):
    if request.method == "POST":
        ...
        return redirect(f"/museme/songs/{music_id}")
    ...
    return render(request, 'museme/history.htm', {"history": song})
...
def watchlater(request):
    if request.method == "POST":
        ...
        return render(request, f"museme/songpost.htm", {'song': song, "message": message})
    ...
    return render(request, "museme/watchlater.htm", {'song': song})

def songs(request):
    song = Song.objects.all()
    return render(request, 'museme/songs.htm', {'song': song})

def songpost(request, id):
    song = Song.objects.filter(song_id=id).first()
    return render(request, 'museme/songpost.htm', {'song': song})
...
def login(request):
    ...
    return render(request, 'museme/login.htm')
...
def signup(request):
    ...
    return render(request, 'museme/signup.htm')
...
def channel(request, channel):
    ...
    return render(request, "museme/channel.htm", {"channel": chan, "song": song})
...
def upload(request):
    ...
    return render(request, "museme/upload.htm")
